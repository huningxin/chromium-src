...
const batchNormTests = [
  ...
  // Tests for dynamic dimensions
  {
    'name':
        'batchNormalization float32 2D tensor with dynamic batch dimension default options',
    'graph': {
      'inputs': {
        'bnInput': {
          'data': [
          ...
          'descriptor':
              {shape: [{'name': 'N', 'maxSize': 5}, 6], dataType: 'float32'},
          'shape': [4, 6]
        },
        'bnMean': {
          'data': [
  ...
  {
    'name':
        'batchNormalization float32 2D tensor with dynamic channel dimension default options',
    'graph': {
      'inputs': {
        'bnInput': {
          'data': [
          ...
          'descriptor':
              {shape: [4, {'name': 'C', 'maxSize': 10}], dataType: 'float32'},
          'shape': [4, 6]
        },
        'bnMean': {
          'data': [
  ...
  {
    'name':
        'batchNormalization float32 3D tensor with dynamic channel dimension default options',
    'graph': {
      'inputs': {
        'bnInput': {
          'data': [
          ...
          'descriptor':
              {shape: [2, {'name': 'C', 'maxSize': 5}, 4], dataType: 'float32'},
          'shape': [2, 3, 4]
        },
        'bnMean': {
          'data': [12.810380935668945, 63.13715362548828, -61.62983322143555],
          'descriptor':
              {shape: [{'name': 'C', 'maxSize': 5}], dataType: 'float32'},
          'shape': [3]
        },
        'bnVariance': {
          'data': [18.358240127563477, 41.847232818603516, 16.12828254699707],
  ...
  {
    'name':
        'batchNormalization float32 3D tensor with dynamic channel dimension no scale no bias',
    'graph': {
      'inputs': {
        'bnInput': {
          'data': [
  ...
  {
    'name':
        'batchNormalization float32 4D tensor with dynamic channel dimension default options',
    'graph': {
      'inputs': {
        'bnInput': {
          'data': [
  ...
  {
    'name':
        'batchNormalization float32 4D tensor with dynamic channel dimension options.axis=1',
    'graph': {
      'inputs': {
        'bnInput': {
          'data': [
  ...
  {
    'name':
        'batchNormalization float32 4D tensor with dynamic spatial dimensions default options',
    'graph': {
      'inputs': {
        'bnInput': {
          'data': [
          ...
          'descriptor': {
            shape: [
              2, 3, {'name': 'H', 'maxSize': 5}, {'name': 'W', 'maxSize': 5}
            ],
            dataType: 'float32'
          },
          'shape': [2, 3, 2, 2]
  ...
  {
    'name':
        'batchNormalization float32 4D tensor with all dynamic dimensions default options',
    'graph': {
      'inputs': {
        'bnInput': {
          'data': [
          ...
          'descriptor': {
            shape: [
              {'name': 'N', 'maxSize': 5}, {'name': 'C', 'maxSize': 5},
              {'name': 'H', 'maxSize': 5}, {'name': 'W', 'maxSize': 5}
            ],
            dataType: 'float32'
          },
          'shape': [2, 3, 2, 2]
  ...
  {
    'name':
        'batchNormalization float16 3D tensor with dynamic channel dimension default options',
    'graph': {
      'inputs': {
        'bnInput': {
          'data': [
            -41.3125,  64.0625,   -63.375,   -46.78125, 83,        -80.0625,
            -62.15625, -0.100098, -40.90625, 56.96875,  37.375,    57.03125,
            82.0625,   -86.125,   76.875,    97,        -21.34375, -96.9375,
            -9.359375, 80.1875,   -85.375,   62.34375,  -68.5,     -12.109375
          ],
          'descriptor':
              {shape: [2, {'name': 'C', 'maxSize': 5}, 4], dataType: 'float16'},
          'shape': [2, 3, 4]
        },
        'bnMean': {
          'data': [12.8125, 63.125, -61.625],
          'descriptor':
              {shape: [{'name': 'C', 'maxSize': 5}], dataType: 'float16'},
          'shape': [3]
        },
        'bnVariance': {
          'data': [18.359375, 41.84375, 16.125],
      ...
      'expectedOutputs': {
        'bnOutput': {
          'data': [
            -12.6328125, 11.9609375, -17.78125,     -13.90625,   3.072265625,
            -22.140625,  -19.359375, -9.7734375,    5.16015625,  29.546875,
            24.65625,    29.546875,  16.15625,      -23.09375,   14.953125,
            19.640625,   -13.0625,   -24.734375,    -11.2109375, 2.63671875,
            -5.9140625,  30.875,     -1.7119140625, 12.328125
          ],
          'descriptor':
              {shape: [2, {'name': 'C', 'maxSize': 5}, 4], dataType: 'float16'},
  ...
  {
    'name':
        'batchNormalization float32 4D tensor with dynamic dimension on axis=2',
    'graph': {
      'inputs': {
        'bnInput': {
          'data': [
          ...
          'descriptor': {
            shape: [2, 2, {'name': 'H', 'maxSize': 5}, 3],
            dataType: 'float32'
          },
          'shape': [2, 2, 2, 3]
        },
        'bnMean': {
          'data': [-23.41889190673828, 60.25288772583008],
          'descriptor':
              {shape: [{'name': 'H', 'maxSize': 5}], dataType: 'float32'},
          'shape': [2]
        },
        'bnVariance': {
          'data': [3.2451305389404297, 41.60662841796875],
          'descriptor':
              {shape: [{'name': 'H', 'maxSize': 5}], dataType: 'float32'},
          'shape': [2]
        }
      ...
      'expectedOutputs': {
        'bnOutput': {
          'data': [
            -9.930147171020508,  48.57677459716797,   -22.181177139282227,
            -16.595029830932617, 3.529961347579956,   -21.756031036376953,
            -21.497112274169922, 12.94460391998291,   -9.705230712890625,
            -0.5100250840187073, -3.547170877456665,  -0.4970930218696594,
            58.551177978515625,  -34.80436706542969,  55.67921829223633,
            5.702156066894531,   -12.651143074035645, -24.3695068359375,
            7.804689884185791,   57.52501678466797,   -34.388916015625,
            0.32540470361709595, -19.956422805786133, -11.21805477142334
          ],
          'descriptor': {
            shape: [2, 2, {'name': 'H', 'maxSize': 5}, 3],
            dataType: 'float32'
